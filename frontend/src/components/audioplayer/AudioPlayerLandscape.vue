<!-- LandscapeAudioPlayer.vue -->
<template>
  <div class="landscape-player" :class="{ 'playing': isPlaying }">
    <div class="player-layout">
      <!-- Left Side: Cover Art Display -->
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function loadTrack(track: AudioTrack): void {
      console.log('Here Loading track:', track);
      if (!track || !track.src || !audioElement.value) return;
      console.log('Loading track source:', track.src);
      audioElement.value.src = track.src;
      audioElement.value.load();
      currentTime.value = 0;
      progressPercentage.value = 0;
      console.log('Loading track:', track.title);
      console.log('Track source:', audioElement.value.src);
...
.landscape-player.playing .cover-art {
